...
<body>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <h2>FUnleash Your Creativity with Exquisite Stationery from Pooranmal & Sons</h2>
    ...
    <div class="container-fluid home-slider-container" style="padding-left:0px!important;padding-right:0px!important;background:#cadbea;">
        <div class="home-slider">
            <div class="background-img home-slide-1"
                style="background-image:url('{{ URL::to('assets/img/slider-1-bg.png'); }}')">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-5 bg-slider-content">
                            <!-- <p><b>Get Recognized in a Blink of an Eye</b></p> -->
                            <h2>Branding & Marketing With Impressive and Unique Designs</h2>
                            <p>Get your brand recognized instantly with a bespoke <br> branding and marketing experience</p>
                            <!-- <ul>
                                <li> More than 12 Years Experience </li>
                                <li> Clients Across 45 Industries </li>
                                <li> Money-Back Guarantee </li>
                                <li> Industry Specific Designers </li>
                            </ul> -->
                            <a href="#">Read More <i class="pl-2 fa-solid fa-arrow-right-long"></i></a>
                        </div>
            ...
            <div class="background-img home-slide-3"
                style="background-image:url('{{ URL::to('assets/img/slider-1.webp'); }}')">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-7"></div>
                        <div class="col-5 bg-slider-content">
            ...
            <div class="background-img home-slide-2"
                style="background-image:url('{{ URL::to('assets/img/slider-2.png'); }}')">
                <div class="container-fluid">
                    <div class="row">
                        
                        <div class="col-5 bg-slider-content">
                            <!-- <p><b>Get Recognized in a Blink of an Eye</b></p> -->
                            <h2 class="tlt">Branding & Marketing With Impressive and Unique Designs</h2>
                            <p>Get your brand recognized instantly with a bespoke branding and marketing experience</p>
                            <!-- <ul>
                                <li> More than 12 Years Experience </li>
                                <li> Clients Across 45 Industries </li>
                                <li> Money-Back Guarantee </li>
